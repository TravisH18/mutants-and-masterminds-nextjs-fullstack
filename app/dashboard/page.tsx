    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <div className="flex flex-col p-2 shadow-lg w-full h-max gap-3">
          ...
          <div className="w-3/5 text-center p-4 m-4 shadow-lg rounded-lg border border-black place-self-center items-center bg-gradient-to-tr from-orange-600 to-orange-400 via-amber-500">
            <p>Are you a player or a game master today?</p>
          </div>
          ...
          <div className="w-1/2 hover:w-3/5 text-center p-4 m-4 shadow-lg rounded-lg border border-black place-self-center items-center bg-gradient-to-tr from-orange-600 to-orange-400 via-amber-500">
            {/* <a href="/gm/">GM's</a> */}
            <Link href={`/gm/`}>Game Masters</Link>
          </div>
          {/* <div className="w-1/2 hover:w-3/5 text-center p-4 m-4 shadow-lg rounded-lg border border-black place-self-center items-center bg-gradient-to-tr from-orange-600 to-orange-400 via-amber-500">
